...
class LoginRepository {
    ...
    public function getPersonnalApiKey($email, $mdp){
        ...
        return new UserModel($user[0]['id_user'], $user[0]['nom'], $user[0]['prenom'], $user[0]['date_inscription'], $user[0]['email'], $user[0]['prenom'], $user[0]['telephone'], $user[0]['id_role'], $user[0]['apikey']);
    }   

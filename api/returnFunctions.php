...
function returnService($dataFromDb, $id = 0){
    $service = new ServiceModel($dataFromDb[$id]["id_service"], $dataFromDb[$id]["description"], $dataFromDb[$id]["type_service"], $dataFromDb[$id]["date_debut"], $dataFromDb[$id]["date_fin"], $dataFromDb[$id]["id_user"]);
    return $service;
}

...
<html>
	...
	<body class="">
		...
		<main style="background-image: url('../Images/background_images/<?php echo($img) ?>');" id="actualite">

			<section class="flex flexCenter wrap">
				<h1 class="width100 textCenter noMarginBottom">Devenez Partenaire</h1>
				<div class="width100">
					<input class="block marginAuto" type="button" name="becomePatreon" value="Buy us a coffee">
				</div>
			</section>
